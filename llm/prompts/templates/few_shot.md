═══════════════════════════════════════════════════════════════════
ORNEK 1: SSH Hardening (Optimal Cevap Formatı)
═══════════════════════════════════════════════════════════════════
...
echo ""
echo "ONEMLI UYARI:"
echo "   - Devam etmeden önce BASKA BIR TERMINAL ACIN!"
...
ORNEKLER BITTI - SIMDI SENIN SIRADA
